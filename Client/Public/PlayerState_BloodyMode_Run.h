...
class CPlayerState_BloodyMode_Run final : public CPlayerState_Base 
{
private:
		 CPlayerState_BloodyMode_Run();
virtual ~CPlayerState_BloodyMode_Run() = default;
...
public:
	static CPlayerState_BloodyMode_Run* Create(CPlayer* pPlayer);

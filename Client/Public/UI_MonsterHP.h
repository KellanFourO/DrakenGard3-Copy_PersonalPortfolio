...
class CUI_MonsterHP final : public CMyUI
{
public:
...
private:
	CUI_MonsterHP(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL eCurrentLevel);
...
public:
	static CUI_MonsterHP*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL eCurrentLevel); //! 원형객체 생성

...
class CUI_MonsterTagFrame final : public CMyUI
{
public:
...
private:
	CUI_MonsterTagFrame(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL eCurrentLevel);
	CUI_MonsterTagFrame(const CUI_MonsterTagFrame& rhs);
	virtual ~CUI_MonsterTagFrame() = default;
...
public:
	static CUI_MonsterTagFrame*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, LEVEL eCurrentLevel); //! 원형객체 생성

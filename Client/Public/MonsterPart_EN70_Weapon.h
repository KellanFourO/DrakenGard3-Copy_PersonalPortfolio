...
{
private:
	CMonsterPart_EN70_Weapon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonsterPart_EN70_Weapon(const CMonsterPart_EN70_Weapon& rhs);
	virtual ~CMonsterPart_EN70_Weapon() = default;

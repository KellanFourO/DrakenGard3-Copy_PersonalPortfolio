...
HRESULT CParticle_Red::Initialize_Prototype(LEVEL eLevel)
{
...
CParticle_Red * CParticle_Red::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, LEVEL eLevel)
{

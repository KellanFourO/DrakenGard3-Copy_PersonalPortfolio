...
HRESULT CParticle_Blue::Initialize_Prototype(LEVEL eLevel)
{
...
{
	/* For.Com_Shader */
	if (FAILED(__super::Add_Component(m_eCurrentLevelID, TEXT("Prototype_Component_Shader_Particle_Rect"),
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Component(m_eCurrentLevelID, TEXT("Prototype_Component_Texture_Snow"),
...
CParticle_Blue * CParticle_Blue::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, LEVEL eLevel)
{

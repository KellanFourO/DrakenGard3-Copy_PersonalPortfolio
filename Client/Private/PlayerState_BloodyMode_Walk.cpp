#include "stdafx.h"
#include "Player.h"
#include "PlayerState_BloodyMode_Walk.h"
...
CPlayerState_BloodyMode_Walk::CPlayerState_BloodyMode_Walk()
{
}

HRESULT CPlayerState_BloodyMode_Walk::Initialize(CPlayer* pPlayer)
{
...
HRESULT CPlayerState_BloodyMode_Walk::StartState()
{
...
HRESULT CPlayerState_BloodyMode_Walk::EndState()
{
...
void CPlayerState_BloodyMode_Walk::Tick(const _float& fTimeDelta)
{
    MouseInput(fTimeDelta);
	KeyInput(fTimeDelta);
}

void CPlayerState_BloodyMode_Walk::Late_Tick(const _float& fTimeDelta)
{
...
void CPlayerState_BloodyMode_Walk::KeyInput(const _float& fTimeDelta)
{
...
CPlayerState_BloodyMode_Walk* CPlayerState_BloodyMode_Walk::Create(CPlayer* pPlayer)
{
	CPlayerState_BloodyMode_Walk* pInstance = new CPlayerState_BloodyMode_Walk();

	/* 원형객체를 초기화한다.  */
	if (FAILED(pInstance->Initialize(pPlayer)))
	{
		MSG_BOX("Failed to Created : CPlayerState_BloodyMode_Walk");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CPlayerState_BloodyMode_Walk::Free()
{
	__super::Free();
}

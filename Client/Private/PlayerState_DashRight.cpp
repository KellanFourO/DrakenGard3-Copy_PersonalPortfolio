...
void CPlayerState_DashRight::Create_DashRing()
{
    ...
    //XMStoreFloat3(&Desc.vCreateLook, pPlayer->Get_Transform()->Get_State(CTransform::STATE_LOOK));

    m_pGameInstance->Add_CloneObject(LEVEL_GAMEPLAY, TEXT("Layer_Effect"), TEXT("Prototype_GameObject_Effect_DashRing"), &Desc);
}

void CPlayerState_DashRight::Create_Hanabira(_float fTimeDelta)
{

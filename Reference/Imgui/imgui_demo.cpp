...
// GAMELOGIC in this file will be stripped out by the linker if you don't call ImGui::ShowDemoWindow().
...
// Clang/GCC warnings with -WGAMELOGIC
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        ImGui::Checkbox("Embed GAMELOGIC inside a child window for testing _RootWindow flag.", &embed_all_inside_a_child_window);
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            ImGui::DragFloat("global scale", &io.FontGlobalScale, 0.005f, MIN_SCALE, MAX_SCALE, "%.2f", ImGuiSliderFlags_AlwaysClamp); // Scale GAMELOGIC
            ImGui::PopItemWidth();

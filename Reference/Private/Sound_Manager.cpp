...
HRESULT CSound_Manager::Ready_Sound()
{
	...
	Load_SoundFile_GroupAsync(L"ENVIRONMENT_EFFECT", "../Bin/Resources/Sound/EFFECT/BORNFIRE/");
...
// 	Load_SoundFile_GroupAsync(L"CRITICAL", "../Bin/Resources/Sound/Hit/");
	...
	////Wait_GroupAsync();
	//Load_SoundFile_GroupAsync(L"Player", "FOOT"); //ok 
	////Wait_GroupAsync();
	//Load_SoundFile_GroupAsync(L"Skill", "SKILL"); //ok 
	////Wait_GroupAsync();
	//Load_SoundFile_GroupAsync(L"UI", "UI"); //ok 
	//Wait_GroupAsync();

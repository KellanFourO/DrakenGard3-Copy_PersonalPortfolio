...
CMyUI::CMyUI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CGameObject(pDevice, pContext)
{
}

CMyUI::CMyUI(const CGameObject& rhs)
	: CGameObject(rhs)
{
}

HRESULT CMyUI::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CMyUI::Initialize(void* pArg)
{
...
void CMyUI::Priority_Tick(_float fTimeDelta)
{
}

void CMyUI::Tick(_float fTimeDelta)
{
}

void CMyUI::Late_Tick(_float fTimeDelta)
{
...
void CMyUI::SetUp_UV(_uint iTextureIndex)
{
	//!Get_TextureSize
	//! 
	//! m_tUIInfo.fTexSizeX
...
void CMyUI::SetUp_WorldToScreen(_fvector vWorldPos)
{
	_vector vTargetPos = {};
	_float4 vViewPort = {};
...
//void CMyUI::SetUp_ScreenToWorld(_float fScreenX, _float fScreenY)
//{
//	// 화면 좌표를 정규화된 좌표로 변환
...
HRESULT CMyUI::SetUp_Transform(_float fPosX, _float fPosY, _float fSizeX, _float fSizeY)
{
	if (nullptr == m_pTransformCom)
		return E_FAIL;
...
HRESULT CMyUI::SetUp_BillBoarding()
{
...
HRESULT CMyUI::SetUp_ScreenPosRect(_float fPosX, _float fPosY, _float fScaleX, _float fScaleY)
{
...
HRESULT CMyUI::Ready_Components()
{
...
HRESULT CMyUI::Bind_ShaderResources()
{

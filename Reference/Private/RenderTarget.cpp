...
#include "Shader.h"
#include "VIBuffer_Rect.h" //! 사각형 버퍼로 직교투영 바인딩할거야
...
{
	//TODO 렌더타겟의 클리어 색상이 중요한이유 
	//! 렌더타겟에 클리어컬러는 굉장히 중요해 추후 설명
...
HRESULT CRenderTarget::Ready_Debug(_float fX, _float fY, _float fSizeX, _float fSizeY)
{
	...
	m_WorldMatrix._11 = fSizeX; //! 회전 이 없으니까 가능한 11과 22로 스케일 잡기
	...
	m_WorldMatrix._41 = fX - Viewport.Width * 0.5f; //! 직교투영해서 그린다 했잖아
	m_WorldMatrix._42 = -fY + Viewport.Height * 0.5f; //! 직교투영해서 그린다 했잖아

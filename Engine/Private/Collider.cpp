...
HRESULT CCollider::Render()
{
	...
	if (true == m_bOnCollider || true == m_isAttackBody)
		m_pBounding->Render(m_pBatch, XMVectorSet(1.f, 0.f, 0.f, 1.f));
		
	else
		m_pBounding->Render(m_pBatch, XMVectorSet(0.f, 1.f, 0.f, 1.f));
